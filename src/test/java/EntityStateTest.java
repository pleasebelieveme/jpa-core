...
public class EntityStateTest {
    ...
    void test1() {
        ...
        try {
            ...
            Memo memo2 = new Memo(); // 비영속 상태
            memo2.setId(2L);
            memo2.setUsername("Robbert");
            memo2.setContents("비영속과 영속 상태2");
            em.persist(memo2);
    ...
    void test4() {
        ...
        try {
            ...
            // clear()는 지우고 다시 사용가능하지만 close()는 닫아서 사용 못함
            em.close();
